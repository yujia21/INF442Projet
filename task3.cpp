...
int main () {
   //read file
   char* infile1 = "triangles.dat";
   char* infile2 = "triangles.dat";
   char* infile3 = "triangles.dat";   
   ...
   Relation* relationsmid = result1.relations;   
   relationsmid->write("testoutputintermediate");
